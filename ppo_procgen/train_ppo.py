...
flags.DEFINE_string("method_name","vanilla_ppo", "Name of the method")
# Logging
...
def main(argv):
    # Clip rewards for training
        ...
        wandb.init(project='lap_reg_ppo', entity='revisit-spectral-rl', config=FLAGS, name='vanilla_ppo_{}_{}'.format(FLAGS.env_name, FLAGS.seed), 
