...
from models import RegularizerModelTest
...
flags.DEFINE_string("method_name","regularizer", "Name of the method")
...
def main():
        ...
        wandb.init(project='lap_reg_ppo', entity='revisit-spectral-rl', config=FLAGS, name='regularizer_ppo_{}_{}'.format(FLAGS.env_name, FLAGS.seed), 
        ...
        model = RegularizerModelTest(embedding_dim=lap_embed_dim, action_dim=n_actions)
